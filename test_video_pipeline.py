...
from brochure_tracker import BrochureTracker, BrochureLogger
...
def process_video_file(
    ...
    conversation_logger = ConversationLogger(csv_path=BASE_DIR / "logs" / "conversations.csv")
    handshake_logger = HandshakeLogger(csv_path=BASE_DIR / "logs" / "handshakes.csv")
    brochure_logger = BrochureLogger(csv_path=BASE_DIR / "logs" / "brochure_pickups.csv")
    postgres_logger = PostgresLogger()

    brochure_tracker = BrochureTracker(rois={name: None for name in quadrant_names})
