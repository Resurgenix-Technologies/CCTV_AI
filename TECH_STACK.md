...
| :--- | :--- | :--- | :--- |
| **Person Detection & Tracking** | **YOLOv8x-Pose (Ultralytics)** | Multi-camera person detection, track ID assignment (ByteTrack/BoT-SORT), and body pose keypoint estimation (NVIDIA GPU FP16). | Bounding boxes, track IDs, 17-point pose keypoints |
...
### E. Multi-Modal Conversation Analytics ([conversation_tracker.py](file:///c:/Users/inter/Downloads/PRIVATE_TEST_cctv-sarisht-test/conversation_tracker.py))
...
- **CSV Logging**: Thread-safe structured log store (`logs/conversations.csv`).
